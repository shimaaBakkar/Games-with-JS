...
login.addEventListener("click",register)
    ...
    function register(e){
        ...
        // let exist =arr.length || JSON.parse(localStorage.getItem("users")).some(data => 
        ...
        // let exist = arr.length || JSON.parse(localStorage.getItem('users')).some(x =>
        //     x.emailval == emailReg.value && 
        //     x.passval ==  passval.value
